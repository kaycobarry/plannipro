...
includes(cloud, "can('planning', 'move')", 'per-establishment move synchronization guard');
includes(cloud, "App.canAt(establishmentId, 'planning', 'lock')", 'per-establishment lock synchronization guard');
